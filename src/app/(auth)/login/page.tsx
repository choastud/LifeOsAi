        ...
        <Card className="glass-card border-border/40 overflow-hidden shadow-2xl backdrop-blur-xl">
          <CardHeader className="space-y-1 text-center pt-8">
            ...
            <CardDescription className="text-muted-foreground">
              Sign in to access your personal AI ecosystem
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4 pt-4 pb-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href="/reset-password"
                    className="text-xs text-primary hover:underline hover:text-accent font-medium"
                  >
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
                  <Input
                    ...
                    className="bg-background/50 border-border/80 focus:border-primary focus:ring-1 focus:ring-primary rounded-lg pr-10 transition-all"
                    required
                    disabled={loading || googleLoading}
                  />
                  <button
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-transparent px-3 text-muted-foreground font-medium">Or continue with</span>
              </div>
            </div>
            ...
            <Button
              ...
              className="w-full border-border/80 bg-background/30 hover:bg-background/60 hover:text-foreground text-muted-foreground py-6 rounded-lg font-medium transition-all duration-300 flex items-center justify-center gap-2"
              disabled={loading || googleLoading}
            >
              {googleLoading ? (
                <Loader2 className="w-5 h-5 animate-spin" />
          ...
          <CardFooter className="flex flex-col space-y-4 pb-8 pt-2 bg-muted/20 border-t border-border/20">
